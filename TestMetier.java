...
public class TestMetier {
	...
	public static void testCrediterDebiterJoueur () {
		...
		try {
			...
			// crédit de joueurs incorrects

			try {
				siteDeParisMetier.crediterJoueur("Maradona", null, "world1Champ", 12, new String("ilesCaimans"));
				System.out.println("créditer un joueur avec un prenom invalide (non instancié) n'a pas levÃ© l'exception JoueurException");
			}
			catch (JoueurException e) {System.out.println("Test 5.1: ça marche"); }
			catch (Exception e) { 
				System.out.println("créditer un joueur avec un prenom invalide (non instancié)  n'a pas levÃ© l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur(null, "Diego", "world2Champ", 12, new String("ilesCaimans"));
				System.out.println("créditer un joueur avec un nom invalide (non instancié) n'a pas levÃ© l'exception JoueurException");
			}
			catch (JoueurException e) { System.out.println("Test 5.2: ça marche");}
			catch (Exception e) { 
				System.out.println("créditer un joueur avec un nom invalide (non instancié)  n'a pas levÃ© l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur("Maradonaa", "Diegoa", null, 12, new String("ilesCaimans"));
				System.out.println("créditer un joueur avec un pseudo invalide (non instancié) n'a pas levÃ© l'exception JoueurException");
			}
			catch (JoueurException e) { System.out.println("Test 5.3: ça marche");}
			catch (Exception e) { 
				System.out.println("créditer un joueur avec un pseudo invalide (non instancié)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur("Maradonab", "Diegob", "world3Champ",12, null);
				System.out.println("créditer un joueur avec un password gestionnaire  invalide (non instancié) n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { System.out.println("Test 5.4: ça marche");}
			catch (Exception e) { 
				System.out.println("créditer un joueur avec un password gestionnaire  invalide (non instancié) n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
			try {
				siteDeParisMetier.crediterJoueur(new String("Duran"), new String(" "), "world4Champ", 12, new String("ilesCaimans"));
			...
			catch (JoueurException e) { System.out.println("Test 5.5: ça marche");}
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un prÃ©nom invalide (un seul caractère : espace)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur("Dur an", "Carlos", "world5Champ", 12, new String("ilesCaimans"));
				System.out.println("crediter un joueur avec un nom invalide (Dur an) n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { System.out.println("Test 5.6: ça marche");}
			catch (Exception e) { 
			...
			try {
				...
				System.out.println("crediter un joueur avec un nom invalide (un caractÃ¨re ') n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { System.out.println("Test 5.7: ça marche");}
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un nom invalide (un caractÃ¨re ')  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur(new String("Nobel"), new String("Alfred"), new String("tnt"), 12, new String("ilesCaimans"));
			...
			try {
				siteDeParisMetier.crediterJoueur("Nobela", "Alfreda", "tnt.43", 12, new String("ilesCaimans"));
				...
				System.out.println("crediter un joueur avec un pseudo invalide (un caractÃ¨re .)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur("Durana", "Robertoa", "worldChampa", 12, "abef");
				System.out.println("crediter un joueur avec un password gestionnaire  invalide (moins de 8 caractères) n'a pas levÃ© l'exception MetierException");
			}
			catch (MetierException e) { System.out.println("Test 5.10: ça marche");}
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un password gestionnaire  invalide (moins de 8 caractères) n'a pas levÃ© l'exception MetierException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur("Duranb", "Robertob", "worldChampb", 12, "onSaitJamais");
				System.out.println("crediter un joueur avec un password gestionnaire  incorrect n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { System.out.println("Test 5.11: ça marche");}
			catch (Exception e) { 
			...
			try {
				siteDeParisMetier.crediterJoueur(new String("Duranb"), new String("Robertob"), new String("Machete"), 12, new String("ilesCaimans"));
				System.out.println("crediter un joueur inexistant (mauvais pseudo) n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { System.out.println("Test 5.12: ça marche");}
			catch (Exception e) { 
				System.out.println("crediter un joueur inexistant (mauvais pseudo) n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}


			try {
				siteDeParisMetier.crediterJoueur(new String("Duranb"), new String("RobertobMachete"), new String("worldChampb"), 12, new String("ilesCaimans"));
				System.out.println("crediter un joueur inexistant (mauvais prenom) n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { System.out.println("Test 5.13: ça marche");}
			catch (Exception e) { 
				System.out.println("crediter un joueur inexistant (mauvais prenom) n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur(new String("DuranbMachete"), new String("Robertob"), new String("worldChampb"), 12, new String("ilesCaimans"));
				System.out.println("crediter un joueur inexistant (mauvais nom) n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { System.out.println("Test 5.14: ça marche");}
			catch (Exception e) { 
				System.out.println("crediter un joueur inexistant (mauvais nom) n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}




			// Crédit incorrect des joueurs 
         
			try {
				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), -12, new String("ilesCaimans"));
				System.out.println("mal crediter un joueur (somme négative) n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { System.out.println("Test 5.15: ça marche");}
			catch (Exception e) { 
				System.out.println("mal crediter un joueur (somme négative) n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
         
         //Crédit correct des joueurs
         try {
       
            System.out.println("Le compte de Bernard est de " + siteDeParisMetier.getAllJoueurs().get(0).getSommeEnJeton());
            ...
            System.out.println("Test 5.16 : ça marche");
				...
				System.out.println("bien crediter un joueur a levé " + e.getClass().getName());
			}
      }
      catch (Exception e) {
			System.out.println("\n Exception imprévue : " + e);
      ...
      try {
         ...
         // on crédite les joueurs de 1001 jetons
         ...
         //Début des tests
			...
			try {
				...
				System.out.println("debiter un joueur avec un prenom invalide (non instancié) n'a pas levÃ© l'exception JoueurException");
			}
			catch (JoueurException e) {System.out.println("Test 5.17: ça marche"); }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un prenom invalide (non instancié)  n'a pas levÃ© l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("debiter un joueur avec un pseudo invalide (moins de 4 caractères)  n'a pas levÃ© l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.debiterJoueur("Nobela", "Alfreda", "tnt.43", 12, new String("ilesCaimans"));
				System.out.println("debiter un joueur avec un pseudo invalide (un caractère .) n'a pas levÃ© l'exception JoueurException");
			}
			catch (JoueurException e) { System.out.println("Test 5.25: ça marche");}
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un pseudo invalide (un caractère .)  n'a pas levÃ© l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.debiterJoueur("Durana", "Robertoa", "worldChampa", 12, "abef");
				System.out.println("debiter un joueur avec un password gestionnaire  invalide (moins de 8 caractères) n'a pas levÃ© l'exception MetierException");
			}
			catch (MetierException e) { System.out.println("Test 5.26: ça marche");}
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un password gestionnaire  invalide (moins de 8 caractères) n'a pas levÃ© l'exception MetierException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("mal debiter un joueur (somme négative) n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { System.out.println("Test 5.31: ça marche");}
			catch (Exception e) { 
				System.out.println("mal debiter un joueur (somme négative) n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
         try {
				...
				System.out.println("mal debiter un joueur (debit superieur au solde) n'a pas levÃ© l'exception JoueurException mais " + e.getClass().getName());
			}
         
         //Débit correct des joueurs
         try {
            Joueur FrancoiseProu = siteDeParisMetier.getAllJoueurs().get(1);
            System.out.println("Le compte de Francoise est de " + siteDeParisMetier.getAllJoueurs().get(1).getSommeEnJeton());
            ...
            System.out.println("Test 5.33 : ça marche");
				...
				System.out.println("bien debiter un joueur a levé " + e.getClass().getName());
			}
		...
		try {
			// construction correcte d'un site
				...
				try {
					...
					System.out.println("Il y a un misÃ© negative et n'eleve pas Exception");
				}
	...
	public static void testSolderVainqueur () {
		...
		try {
			...
			try {
				siteDeParisMetier.desinscrireJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), "ilesCaimans");
				System.out.println("désinscrire un joueur avec un  pari en cours n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("désinscrire un joueur avec un  pari en cours. n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			} 
